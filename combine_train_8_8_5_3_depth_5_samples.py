...
class TrainPipeline():
    def __init__(self, init_model=None):
        ...
        self.depth = 3#TRAINING_PARAMETERS[self.board_type]['depth']
        ...
        self.fictitious_agent = Fictitious_Agent(policy_value_function=self.policy_value_net.policy_value_fn,
                                                 ...
                                                 depth=self.depth,
                                                 action_sample_count=5)#TRAINING_PARAMETERS[self.board_type]['action_sample_count']
            ...
            for i in range(self.game_batch_num):
                ...
                if len(self.data_buffer) > self.batch_size:
                    ...
                    if i % self.save_freq == 0:
                        self.policy_value_net.save_model('./current_combined_8_8_5.model')
                ...
                if (i+1) % self.check_freq == 0:
                    ...
                    self.policy_value_net.save_model('./current_combined_6_6_4.model')
                    if win_ratio > self.best_win_ratio:
                        print("New best policy!!!!!!!!")
                        self.best_win_ratio = win_ratio
                        # update the best_policy
                        self.policy_value_net.save_model('./best_combined_6_6_4.model')
